...
Keliauk į Lietuvos hidrometeorologijos tarnybos svetainę ([https://www.meteo.lt/](https://www.meteo.lt/)), kur gali rasti API dokumentaciją. Labai ramiai perskaityk pradžią, paanilizuok kuo skiriasi:
...
Tada ramiai išstudijuok reikiamos API dokumentaciją. Eksperimentuok ir išbandyk. Prisimink kaip dirbai su API ankstesniuose skyriuose, kur parsisiuntinėjai duomenis iš [https://data.gov.lt/](https://data.gov.lt/).
